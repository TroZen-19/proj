    ...
    <Box className={classes.root_contactus}>
      ...
      <div className={classes.contact_Container_contactus}>
        ...
        <Typography variant="body2" className={classes.para_contact}>
         You can contact us through our social media handle and call us directly at ...
          <strong
            style={{
        ...
        <Typography variant="body2" className={classes.para_contact}>
        <span className={classes.para2}>we are available and we will respond to you at</span>
        <br />
          <span className={classes.para2}>7:00 am -6:00 pm Sunday-Friday</span>
          <br />
          <span className={classes.para2}>9:00 am -4:00 pm Saturday</span>
          <br />
          <span className={classes.para2}>Closed during the festival only</span>
        </Typography>
