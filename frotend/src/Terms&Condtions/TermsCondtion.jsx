  ...
  return (
    <div className="terms-container">
      ...
      <div className="terms-content">
        <p>
          Thank you for shopping with Tama Fashion Wear! We appreciate your business
          and your interest in our product. We want to make sure you
        ...
        <p>
          You (“Customer”) may place orders for Products with Tama Fashion Wear
          ...
          agreed to in writing by Tama Fashion Wear.
        </p>
        <h2>Orders</h2>
        <p>
          All orders are subject to Tama Fashion Wear's acceptance. We may refuse to
        ...
        <p>
          ...
          Tama Fashion Wear. Prices displayed on the website exclude shipping
          ...
          from those in physical stores that stock Tama Fashion Wear products. We
        ...
        <p>
          ...
          taxes, except for those based on Tama Fashion Wear's income. If
          Tama Fashion Wear is required to collect and pay taxes on Customer's
        ...
        <p>
          ...
          order without Tama Fashion Wear's written consent. You may return products
        ...
        <p>
          You agree to indemnify and hold Tama Fashion Wear harmless from any
          claims, costs, proceedings, losses, or demands arising from your
          breach of these Terms or anyone using your account.
        </p>
        <h2>Entire Agreement</h2>
        <p>
          These Terms constitute the entire agreement between Tama Fashion Wear and
