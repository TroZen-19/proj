    ...
    <div className="privacy-policy-container">
     <MetaData title={"Privacy Policy"} />
      <div className="container___">
        <h1>Privacy Policy of Tama Fashion Wear</h1>
        <p style={{ fontSize: "16px", fontWeight: "600" }}>
          {" "}
          Effective Date: 20-03-2024
        </p>
        <p>
          At Tama fashion wear, we value the privacy of our customers and are
        ...
        <p>
          By using the Tama Fashion Wear website and services, you agree to the
